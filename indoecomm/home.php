...
<html lang="en">
    ...
    <body class="w3-green">
        ...
        <header class="w3-container w3-white w3-text-black w3-center" style="padding:128px 16px">
            <h1 class="w3-margin w3-jumbo">Indonesia Furniture</h1>
            <p class="w3-xlarge"></p>
            <a class="w3-button w3-black w3-padding-large w3-large w3-margin-top" href="addOrder.php">Pesan Sekarang</a>
        </header>   
