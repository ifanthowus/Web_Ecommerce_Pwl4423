					  ...
					  <div class="w3-white" style="margin: 5% auto; width:65%">
					    ...
					    <div id="search" class="w3-container w3-white w3-padding-16 myLink" style="display: block;">
					      ...
					      <div class="w3-row-padding" style="margin:10px -16px;" id="address">
					        ...
					        <div class="w3-col l7">
					          <label>&nbsp;</label>
					          <input class="w3-input w3-border" name="street" id="street" type="text" placeholder="Street" value="<?php echo htmlspecialchars($row->street1); ?>" required>
					        </div>
					        <div class="w3-col l3">
					          <label>&nbsp;</label>
