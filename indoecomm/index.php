...
<html>
	...
	<div class="w3-card-4 w3-round-large w3-white">
		<div class="w3-container w3-green w3-center" style="margin:0 auto; border-top-right-radius: 8px; border-top-left-radius: 8px" id="title">
			<h1>Welcome</h1>
		</div>
			...
			<div class="w3-container" style="padding: 2%" id="form">
				...
				<div class="w3-center"><input class="w3-btn w3-round w3-black w3-ripple" name="submit" type="submit" value="Login" style="margin-bottom: 5%"></div>
				<span style="color: black;"><i><?php echo '<center>', $error, '</center>'; ?></i></span>
			</div>
			</form>
	</div>
	</body>
